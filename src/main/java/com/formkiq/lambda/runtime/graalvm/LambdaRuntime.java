...
//  }
   ...
   * @throws IOException IOException
   */
  public static void invoke(final com.amazonaws.services.lambda.runtime.RequestHandler handler, final Map<String, String> env) throws IOException {
    String method = null;
  ...
  private static void invokeClass(
      final Map<String, String> env, final com.amazonaws.services.lambda.runtime.RequestHandler handler, final String method) throws IOException {
    String runtimeApi = env.get("AWS_LAMBDA_RUNTIME_API");
    ...
    while (true) {
      ...
      try {
        ...
        Object result = handler.handleRequest( eventBody, context);
        ...
        if (runtimeApi != null) {
          ...
          HttpClient.post(invocationUrl, result.toString());
...
//      final com.amazonaws.services.lambda.runtime.RequestHandler handler, final String methodName, final Context context, final String payload)
//      throws Exception {
//
//    String value = null;
...
//  }
   ...
   * @throws IOException IOException
   */
  public static void innerMain(final com.amazonaws.services.lambda.runtime.RequestHandler handler, final String[] args) throws IOException {
